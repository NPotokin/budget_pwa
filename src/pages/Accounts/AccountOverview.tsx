...
const AccountOverview: React.FC = () => {
	...
	const thisAccountTransactionsTo = transactions.transactions.filter(
		(transaction) => transaction.account_to === thisAccount?.name
	);
	const thisAccountTransactionsFrom = transactions.transactions.filter(
		(transaction) => transaction.account_from === thisAccount?.name
	);
	...
	if (accounts.error || accounts.loading || !thisAccount || transactions.loading) {
		return (
